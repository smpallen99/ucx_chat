defmodule EmojiOne.Data do
  ...
  @ascii_unicode @ascii_hash |> Enum.map(fn {k, v} ->
    new_v =
      v
      |> String.split("-")
  ...
  @sn_unicode @sn_hash |> Enum.map(fn {k, v} ->
    new_v =
      v
      |> String.split("-")
      |> Enum.map(&String.to_integer(&1, 16))
  ...
  @ascii_keys Map.keys(@ascii_hash)

  def shortname_unicode, do: @sn_unicode
  def shortname_hash, do: @sn_hash
  def ascii_hash, do: @ascii_hash
  def ascii_unicode, do: @ascii_unicode
  def ascii_keys, do: @ascii_keys
end
