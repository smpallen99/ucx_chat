  ...
  register_events() {
    ...
    $('body')
      .on('click', 'i[data-edit]', e => {
        ...
        console.log('data-edit', field)
        this.push_userchan('edit', {field: field})
        // userchan.push('notifications_form:edit', {field: field})
        //   .receive("ok", resp => {
        //     if (resp.html) {
        //       // console.log('resp.html', resp.html)
      ...
      .on('click', 'button.save', e => {
        ...
        // userchan.push('notifications_form:save', params)
